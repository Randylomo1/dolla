...
function AppHeader() {
  ...
  const handleLogin = () => {
    window.location.href = `https://oauth.deriv.com/oauth2/authorize?app_id=${encodeURIComponent(import.meta.env.VITE_DERIV_APP_ID)}&redirect_uri=${encodeURIComponent(window.location.origin + '/dashboard')}`;
  };
...
// Renamed the original App component to TradingDashboard
